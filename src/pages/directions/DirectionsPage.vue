<template>
  <div class="min-h-screen bg-gray-50">
    <div class="mx-auto max-w-[1600px] px-4 py-8 sm:px-6 lg:px-8 xl:px-10">
      ...
      <transition name="fade">
        <div
          ...
          class="mt-6 flex items-start justify-between rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700"
        >
